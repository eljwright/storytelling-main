var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            image: '',
            description:'Meanwhile the HOLC, worried about taking on risky loans, made color-coded maps to assess the riskiness of granting home loans in different neighborhoods. They created four different categories that they would rank neighborhoods into. <br><br> These grades were: <br> <p style="color:green; font-size:13px;">A: Best - Green</p> <p style="color:blue;">B: Still Desirable - Blue</p> <p style="color:yellow; font-size:13px;">C: Definitely Declining - Yellow</p> <p style="color:red;">D: Hazardous - Red</p>',
            location: {
                center: [-122.41998, 47.59141],
                zoom: 10.45,
                pitch: 15,
